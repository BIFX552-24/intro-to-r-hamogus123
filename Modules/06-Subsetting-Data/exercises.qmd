...
D will extract the values 11 and 14.
...
The first line of code is trying to return the first twenty columns, while the second line of code is trying to return the first twenty rows.
...
gapminder_small <- gapminder_small[-c(10:18),]
```
